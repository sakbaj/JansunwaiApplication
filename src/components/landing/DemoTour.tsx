...
export function DemoTour() {
  ...
  const getStepConfig = () => {
    switch (currentStep) {
      ...
      default:
        return {
          title: "LNN-Nivaaran Guided Tour",
          avatar: "🤖",
          advisorName: "Mitra AI — Master Guide",
          instruction: "Let's explore LNN-Nivaaran's end-to-end autonomous flow. Click below to enter the Citizen Portal and file an AI-classified complaint.",
