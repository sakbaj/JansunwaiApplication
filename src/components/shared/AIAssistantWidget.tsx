    ...
    if (
      ...
      return {
        text: isHi
          ...
          : "Namaste! I am LNN-Nivaaran. I can help you register a grievance, check your ticket status, or summarize active hotspots in Lucknow.",
      };
    }
          ...
          >
                        ...
                        <div className="p-4 rounded-xl border border-violet-500/20 bg-violet-950/10 backdrop-blur-md space-y-3">
                          <p className="text-xs text-slate-300 leading-relaxed">
                            {isHi
                              ...
                              : "Namaste! I am the LNN-Nivaaran Assistant. You can file civic complaints in Lucknow (garbage, water leakage, street lights) directly through conversation, or track the progress of your grievance tickets."}
                          </p>
            ...
            <div className="p-3 border-t border-slate-800/80 bg-slate-950 flex flex-col gap-2">
              ...
              <div className="flex items-center justify-between text-[9px] text-slate-500 px-1 border-t border-slate-900 pt-1.5">
                ...
                <span className="text-violet-400 font-medium">LNN-Nivaaran Core v2.4</span>
              </div>
            </div>
          </motion.div>
        )}
