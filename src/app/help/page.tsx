  ...
  const faqs = [
    {
      ...
      answer: "When you submit a complaint via text or voice, LNN-Nivaaran's AI pipeline (utilizing state-of-the-art LLMs) processes your description. It analyzes key contextual tokens (e.g. 'leakage', 'pothole', 'refuse heap') to understand your issue, determines the appropriate department (e.g. PWD, Jal Nigam, Power Corporation), and extracts a detailed briefing summary for the designated administrative team.",
      ...
      <main className="min-h-screen pt-24 md:pt-28 pb-16 bg-background relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mb-10 text-center">
            ...
            >
              Have a question about the LNN-Nivaaran platform? Browse our list of frequently asked questions below or search using the dynamic filter.
            </motion.p>
          </div>
