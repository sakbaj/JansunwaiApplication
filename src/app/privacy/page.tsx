      ...
      <main className="min-h-screen pt-24 md:pt-28 pb-16 bg-background relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mb-10 text-center">
            ...
            >
              Learn how LNN-Nivaaran safeguards Uttar Pradesh citizen identity datasets using next-generation cryptographic models and government-grade database compliance policies.
            </motion.p>
          </div>
          ...
          >
            ...
            <section className="space-y-3">
              ...
              <p>
                LNN-Nivaaran process two categories of grievance records:
              </p>
            ...
            <section className="space-y-3">
              ...
              <p>
                Under Section 6 of the DPDP Act 2023, citizens possess complete authority to revoke consent at any moment. You can trigger complete purging of your contact parameters directly through the LNN-Nivaaran support desk at <span className="text-gov-blue font-semibold underline">support@janmitra.gov.in</span>.
              </p>
            </section>
          </motion.div>
        </div>
