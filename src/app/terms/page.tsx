        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <section className="space-y-3">
              ...
              <p>
                LNN-Nivaaran is designed solely for public welfare and civic grievance reporting. Citizens must strictly avoid:
              </p>
