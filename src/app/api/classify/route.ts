...
export async function POST(request: Request) {
  ...
  try {
    ...
    const systemPrompt = `You are the LNN-Nivaaran Smart Governance Classifier for Uttar Pradesh's Jansunwai system. 
...
Return ONLY valid JSON matching this schema. No extra text, no markdown block wrappers.`;
    ...
    const classification = JSON.parse(generatedText.trim());
